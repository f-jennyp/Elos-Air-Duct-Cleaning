<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "Elos Air Duct Cleaning", 
			"phone" =>  "408-445-0411", 		  //either no format or dashed format
			"email" => "elosairduct@gmail.com",   //by default is used as recipient email  
			"address" => "San Jose, CA", 
